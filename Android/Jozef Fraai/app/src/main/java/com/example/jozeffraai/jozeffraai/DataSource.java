...
public class DataSource {
	...
	private String[] assignmentAllColumns = {MySQLiteHelper.COLUMN_ASSIGNMENT_ID,
...
//If the database is open, close it
	...
	public void deleteAssignment(Assignment assignment) {
		if (!database.isOpen())
			open();
		database.delete(MySQLiteHelper.TABLE_ASSIGNMENTS,
				MySQLiteHelper.COLUMN_ASSIGNMENT_ID + " =?", new String[]{
	...
	public void updateAssignment(Assignment assignment) {
		...
		database.update(MySQLiteHelper.TABLE_ASSIGNMENTS, args,
				MySQLiteHelper.COLUMN_ASSIGNMENT_ID + "=?", new String[]{ Long.toString(assignment.getId())
				});
		if (database.isOpen())
			close();
	}
...
//make sure to close the cursor
	...
	public Assignment getAssignment(long columnId) {
		if (!database.isOpen())
			open();
		Cursor cursor = database.query(MySQLiteHelper.TABLE_ASSIGNMENTS,
				assignmentAllColumns, MySQLiteHelper.COLUMN_ASSIGNMENT_ID + "=?", new String[]{
